...
st23:
	if ( ++p == pe )
		goto _test_eof23;
case 23:
#line 467 "ext/ragel_query_parser/parser.c"
	switch( (*p) ) {
		case 33: goto tr43;
		case 37: goto tr44;
		case 43: goto tr45;
...
st24:
	if ( ++p == pe )
		goto _test_eof24;
case 24:
#line 531 "ext/ragel_query_parser/parser.c"
	switch( (*p) ) {
		case 33: goto st24;
		case 37: goto tr47;
		case 38: goto tr48;
...
st25:
	if ( ++p == pe )
		goto _test_eof25;
case 25:
#line 581 "ext/ragel_query_parser/parser.c"
	if ( (*p) == 37 )
		goto st18;
	if ( (*p) < 65 ) {
		if ( 48 <= (*p) && (*p) <= 57 )
...
st28:
	if ( ++p == pe )
		goto _test_eof28;
case 28:
#line 633 "ext/ragel_query_parser/parser.c"
	switch( (*p) ) {
		case 33: goto tr51;
		case 37: goto tr53;
		case 38: goto tr54;
...
st29:
	if ( ++p == pe )
		goto _test_eof29;
case 29:
#line 704 "ext/ragel_query_parser/parser.c"
	switch( (*p) ) {
		case 33: goto tr56;
		case 37: goto tr57;
		case 43: goto tr58;
...
st30:
	if ( ++p == pe )
		goto _test_eof30;
case 30:
#line 754 "ext/ragel_query_parser/parser.c"
	switch( (*p) ) {
		case 37: goto st17;
		case 93: goto st31;
	}
...
st33:
	if ( ++p == pe )
		goto _test_eof33;
case 33:
#line 836 "ext/ragel_query_parser/parser.c"
	switch( (*p) ) {
		case 33: goto st33;
		case 37: goto tr65;
		case 38: goto tr66;
...
st34:
	if ( ++p == pe )
		goto _test_eof34;
case 34:
#line 886 "ext/ragel_query_parser/parser.c"
	if ( (*p) == 37 )
		goto st18;
	if ( (*p) < 65 ) {
		if ( 48 <= (*p) && (*p) <= 57 )
...
st37:
	if ( ++p == pe )
		goto _test_eof37;
case 37:
#line 938 "ext/ragel_query_parser/parser.c"
	switch( (*p) ) {
		case 33: goto tr69;
		case 37: goto tr71;
		case 38: goto tr72;
...
st38:
	if ( ++p == pe )
		goto _test_eof38;
case 38:
#line 967 "ext/ragel_query_parser/parser.c"
	switch( (*p) ) {
		case 33: goto tr35;
		case 37: goto tr74;
		case 43: goto tr75;
...
st9:
	if ( ++p == pe )
		goto _test_eof9;
case 9:
#line 1134 "ext/ragel_query_parser/parser.c"
	switch( (*p) ) {
		case 37: goto st2;
		case 93: goto st10;
	}
...
st40:
	if ( ++p == pe )
		goto _test_eof40;
case 40:
#line 1200 "ext/ragel_query_parser/parser.c"
	switch( (*p) ) {
		case 33: goto st40;
		case 37: goto tr81;
		case 38: goto tr82;
...
st12:
	if ( ++p == pe )
		goto _test_eof12;
case 12:
#line 1240 "ext/ragel_query_parser/parser.c"
	if ( (*p) == 37 )
		goto st18;
	if ( (*p) < 65 ) {
		if ( 48 <= (*p) && (*p) <= 57 )
...
#line 46 "ext/ragel_query_parser/parser.rl"
	...
	break;
#line 1376 "ext/ragel_query_parser/parser.c"
	}
	}
